import {GET_ENTERPRISE_SUCCESS, LIST_ENTERPRISE_SUCCESS, CREATE_ENTERPRISE} from '../constants';
import {getEnterpriseSuccess, createEnterprise, listEnterprisesSuccess} from '../enterprise';

describe('Enterprise actions', () => {
             it('should create an action to get an enterprise', () => {
                    const enterprise = {id: 13, name: 'test'};
    ...
    it('should create an action to list enterprises', () => {
           const enterprises = [{id: 13, name: 'test'}];
           const expectedAction = {
