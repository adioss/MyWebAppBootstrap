...
describe('User edit component',
         () => {
             ...
             beforeEach(() => {
                            props = {save: jest.fn(), cancel: jest.fn(), remove: jest.fn(), changePassword: jest.fn()};
             ...
             it('should render self and sub-components', () => {
                    ...
                    expect(enzymeWrapper.find('h1').text()).toBe('User edition');
                    expect(enzymeWrapper.find('h1').length).toBe(1);
                 expect(enzymeWrapper.find('div').length).toBe(19);
             ...
             it('should render component with given user', () => {
                    ...
                    props = {
                        id: expectedId, username: expectedUserName, email: expectedMail,
                        save: jest.fn(),
                        cancel: jest.fn(),
                        remove: jest.fn()
                    };
             ...
             it('should save edited user on save button click', () => {
                    ...
                    const expectedMail = 'Test email';
                    props = {
                        id: expectedId, name: 'previous value', email: 'previous value',
                        save: jest.fn(),
                        cancel: jest.fn(),
                        remove: jest.fn()
                    };
