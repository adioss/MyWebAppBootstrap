...
import {listEnterprisesSuccess, getEnterpriseSuccess, createEnterprise} from '../../actions/enterprise';
...
function getInitialState() {
    return Map({enterprises: Map(), enterprise: Map()});
}
...
describe('Enterprises reducer',
         () => {
             ...
             it('should return the state with two enterprises', () => {
                    const testedValue = {
                        'enterprises': [
                            createMockedEnterprise(1, 'test'),
                            createMockedEnterprise(2, 'test:')
                        ]
                    };
